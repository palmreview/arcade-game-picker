...
# =============================================================================
# Arcade Game Picker — STABLE BASELINE
# -----------------------------------------------------------------------------
# Baseline tag: v1.7-stable (2026-02-07)
#
# Purpose:
#   This file is the "known good" rollback point. Keep changes conservative.
#
# What’s in this baseline:
#   - Streamlit UI (two-panel layout)
#   - Strict cabinet compatibility filter
#   - ADB (ArcadeItalia) details on-demand (with HTTP fallback links)
#   - Global status persistence via SQLite (game_state.db)
#   - No CSV caching (data updates take effect immediately)
#
# Notes:
#   - On Streamlit Cloud, local SQLite files can reset on redeploy/sleep.
#     If you need durable persistence, migrate status storage to Supabase.
#
# Change policy:
#   - Prefer additive changes behind toggles/expanders.
#   - Avoid large refactors; keep functions small and test after each change.
# =============================================================================
...
APP_VERSION = "1.7-stable (2026-02-07) • Baseline: UI + ADB on-demand + SQLite status • No caching"
